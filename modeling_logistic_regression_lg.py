...
# classification Report
print("LBFGS RIDGE RUS Classification Report for LOW G: \n",classification_report(y_test_dr_new, y_predz))
...
plt.ylabel('Accuracy')
plt.xlabel('Models')
plt.title('Accuracy Comparison of Logistic Regression Models : Low-G')
...
plt.ylabel('F1 Score')
plt.xlabel('Models')
plt.title('F1 Comparison of Logistic Regression Models : Low-G')
plt.xticks(rotation=80)
plt.ylim([0, 1])
...
plt.title('Top 20 Variable Importance Plot : Low-G LBFGS RIDGE RUS Model')
plt.tight_layout()
plt.show()
...
plt.title('Calibration Plot for Low-G Logistic Regression')
plt.legend()
plt.show()