# -*- coding: utf-8 -*-
"""
Dynamic Rollover Decision Tree Models
...
print("RUS DECISION TREE Classification Report: Dynamic Rollover:  \n",classification_report(y_test_dr_new, y_pred))

# Print model parameters used
print("Best Parameters for Random Undersampling Decision Tree : Dynamic Rollover: \n",best_params)
...
# classification Report
print("DECISION TREE Classification Report: Dynamic Rollover:  \n",classification_report(y_test_dr_new, y_pred3))

# Print model parameters used
print("Best Parameters for Decision Tree : Dynamic Rollover: \n",best_params3)
...
plt.title('Pruning Path : Decision Tree Dynamic Rollover')
plt.show()
...
plt.ylabel('Accuracy')
plt.xlabel('Models')
plt.title('Accuracy Comparison of Decision Tree Models : Dynamic Rollover')
...
plt.ylabel('F1 Score')
plt.xlabel('Models')
plt.title('F1 Comparison of Decision Tree Models : Dynamic Rollover')
plt.xticks(rotation=80)
plt.ylim([0, 1])
...
plt.ylabel('Feature')
plt.title('Top 20 Feature Importance Plot for Decision Tree Model : Dynamic Rollover')
plt.show()
